  ...
  function HeaderSEO() {
    return (
      <Head>
        ...
        <meta
          property="og:title"
          content={`Travelogue boasts a fun, exciting, and action-packed travel blog containing a new fun different story in each blog. Types of blog that make you feel you’re in that place. | ${process.env.NEXT_PUBLIC_APP_NAME}`}
        />
        <meta
        ...
        <meta
          property="og:image"
          content={`${process.env.NEXT_PUBLIC_DOMAIN_URL}/travlojournal.svg`}
        />
        <meta
